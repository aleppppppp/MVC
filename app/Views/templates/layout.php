...
<title>Admin STMIK Sinar Nusantara</title>
...
<img src="<?=base_url('assets')?>/dist/img/STMIK.png" alt="AdminLTE Logo"
class="brand-image img-circle elevation-3" style="opacity: .8">
<span class="brand-text font-weight-light">STMIK Sinar Nusantara</span>
</a>
<!-- Sidebar -->
<div class="sidebar">
...
<li class="nav-header">MENU PILIHAN</li>
<li class="nav-item">
...
<strong>Copyright &copy; <?=date('Y')?> Alief Arifin Mahardiko</strong> All rights reserved.
</footer>
<!-- Control Sidebar -->
